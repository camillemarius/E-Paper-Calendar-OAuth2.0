...
void AuthDisplay::show(const String& verificationUrl, const String& userCode) {
    m_display.firstPage();
    do {
...
void AuthDisplay::drawQRCode(const String& url) {
    ...
    //qrcode_initText(&qrcode, qrcodeBytes, 6, ECC_LOW, "www.google.com/device");
